...
/**
 * Empty registry - no hardcoded creators. All data is dynamically discovered from live Kick streams.
 */
...
export function extractDiscoverySignals(stream) {
  ...
  // If stream is associated with Yatra, ensure #yatraroleplay is available as an interactive chip
